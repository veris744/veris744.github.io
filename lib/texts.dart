...
const String kAboutText = "I'm a C++ developer with a strong passion for game development, especially in Gameplay and Tools programming. While completing my master’s degree in game programming, I worked as a frontend developer, and I’m currently working as a C++ developer and DevOps engineer. Over the years, I’ve built games using Unreal Engine, Unity, and native C++, while I also developed this portfolio site from scratch to showcase my work.\n\nI’m fascinated by cutting-edge technologies and the architectural side of software — how large systems are structured and interact behind the scenes. I’m currently working on a custom game engine as a personal project, focused on systems-level design and editor tools. I’ve also explored areas like VR, AI behaviors, and UI systems for games, always with the goal of creating responsive, engaging experiences. I'm hard-working, technically skilled, and enjoy collaborating with others to bring ideas to life.";
...
"Small C++ game engine I'm currently working on.\n\nKey Aspects (already implemented):";
